...
Téléchargez les fichiers banks_project.py et exchange_rate.csv dans le même dossier.

Installez les bibliothèques nécessaires avec la commande : pip install pandas beautifulsoup4 requests.

Exécutez le script : python banks_project.py.

Consultez le fichier code_log.txt pour voir l'historique d'exécution.
